	...
	lieu["j0h0"] = [];
	lieu["j0h0"][0] = ["j0h0r0", "Lieu 1"];
	lieu["j0h0"][1] = ["j0h0r1", "Lieu 2"];
	//Matin
	lieu["j0h1"] = [];
	lieu["j0h1"][0] = ["j0h1r0", "Lieu 1"];
	//Après midi
	lieu["j0h2"] = [];
	lieu["j0h2"][0] = ["j0h2r0", "Lieu 1"];
	 
	
	//        MARDI
	//Activité spécial 7h-9h
	lieu["j1h0"] = [];
	lieu["j1h0"][0] = ["j1h0r0", "Lieu 1"];
	//Matin
	lieu["j1h1"] = [];
	lieu["j1h1"][0] = ["j1h1r0", "Lieu 1"];
	//Après midi
	lieu["j1h2"] = [];
	lieu["j1h2"][0] = ["j1h2r0", "Lieu 1"];
	
	
	//        MERCREDI
	//Activité spécial 7h-9h
	lieu["j2h0"] = [];
	lieu["j2h0"][0] = ["j2h0r0", "Lieu 1"];
	//Matin
	lieu["j2h1"] = [];
	lieu["j2h1"][0] = ["j2h1r0", "Lieu 1"];
	//Après midi
	lieu["j2h2"] = [];
	lieu["j2h2"][0] = ["j2h2r0", "Lieu 1"];
	
	//        JEUDI
	//Activité spécial 7h-9h
	lieu["j3h0"] = [];
	lieu["j3h0"][0] = ["j3h0r0", "Lieu 1"];
	//Matin
	lieu["j3h1"] = [];
	lieu["j3h1"][0] = ["j3h1r0", "Lieu 1"];
	//Après midi
	lieu["j3h2"] = [];
	lieu["j3h2"][0] = ["j3h2r0", "Lieu 1"];
	
	//        VENDREDI
	//Activité spécial 7h-9h
	lieu["j4h0"] = [];
	lieu["j4h0"][0] = ["j4h0r0", "Lieu 1"];
	//Matin
	lieu["j4h1"] = [];
	lieu["j4h1"][0] = ["j4h1r0", "Lieu 1"];
	//Après midi
	lieu["j4h2"] = [];
	lieu["j4h2"][0] = ["j4h2r0", "Lieu 1"];
	
	//        SAMEDI
	//Activité spécial 7h-9h
	lieu["j5h0"] = [];
	lieu["j5h0"][0] = ["j5h0r0", "Lieu 1"];
	//Matin
	lieu["j5h1"] = [];
	lieu["j5h1"][0] = ["j5h1r0", "Lieu 1"];
	//Après midi
	lieu["j5h2"] = [];
	lieu["j5h2"][0] = ["j5h2r0", "Lieu 1"];
	
	//        DIMANCHE
	//Activité spécial 7h-9h
	lieu["j6h0"] = [];
	lieu["j6h0"][0] = ["j6h0r0", "Lieu 1"];
	//Matin
	lieu["j6h1"] = [];
	lieu["j6h1"][0] = ["j6h1r0", "Lieu 1"];
	//Après midi
	lieu["j6h2"] = [];
	lieu["j6h2"][0] = ["j6h2r0", "Lieu 1"];
